...
class DatabaseTests(unittest.TestCase):
    def test_ensure_database_creates_sqlite_schema(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("user_stories", table_names)
            self.assertIn("user_story_traceability", table_names)
            self.assertIn("business_rules", table_names)
            self.assertIn("business_rule_examples", table_names)
            self.assertIn("business_rule_story_links", table_names)
