...
export function createSearchEnabledDataProvider({
  ...
  return {
    ...
    async updateMany(resource, params) {
      return baseProvider.updateMany(resolveSchemaResourceKey(schema, resource), params);
    },
    ...
    async deleteMany(resource, params) {
      return baseProvider.deleteMany(resolveSchemaResourceKey(schema, resource), params);
    },
  };
}
