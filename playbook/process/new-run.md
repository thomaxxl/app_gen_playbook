...
6. reset local `../../runs/current/notes.md` to a neutral placeholder
7. clear or recreate local:
   - `../../runs/current/artifacts/`
   - `../../runs/current/evidence/`
   - `../../runs/current/role-state/`
8. ensure the evidence lane is ready to record at least:
   - command logs
...
9. seed `../../runs/current/role-state/product_manager/inbox/INPUT.md` from
   `../../runs/current/input.md`
10. seed `../../runs/current/artifacts/architecture/capability-profile.md`
   from `../../runs/template/artifacts/architecture/capability-profile.md`
11. seed `../../runs/current/artifacts/architecture/load-plan.md`
    from `../../runs/template/artifacts/architecture/load-plan.md`
12. if packaging or runtime normalization is expected for the run, recreate
   `../../runs/current/artifacts/devops/` from the starter stub set
13. if packaging or runtime normalization is expected for the run, ensure
    `../../runs/current/role-state/devops/` exists
14. ensure the dormant `../../runs/current/role-state/ceo/` lane exists for
    stalled-run intervention, but do not seed it with active work
15. leave `../../specs/contracts/`, `../../specs/features/`, and the generic
   template directories unchanged
16. create local gitignored `../../app/` and seed the role-owned subtree roots:
    - `../../app/frontend/`
    - `../../app/backend/`
    - `../../app/rules/`
    - `../../app/reference/`
