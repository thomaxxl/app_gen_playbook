# Architect Authoring Core Read Set

Use this as the Tier 1 startup read set for Phase 2 and other
architecture-authoring work.
...
enabled feature artifacts required by the current authoring task.
