# Backend Design Core Read Set

Use this as the Tier 1 startup read set for Phase 4 backend-design work.
...
feature packs required by the current backend-design task.
