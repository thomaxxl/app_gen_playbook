...
| View ID | Route | View class | Required or optional | Starter compatible | Standard page shell required | Page header layout | Summary-card usage | Data joins needed | Main interactions | CTA and recovery behavior | Chart text fallback | Mobile fallback | Acceptance hooks | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| replace | replace | Home/Landing/CustomDashboard/other custom | required/optional | yes/no | yes/no/custom shell | replace | replace | replace | replace | replace | replace | replace | replace | replace |
